...
export default function Home() {
  ...
  const getList = async () => {
    ...
    await fetch(`https://polygon-mainnet.g.alchemy.com/nft/v2/${process.env.alchemyAPI}/getOwnersForCollection?contractAddress=${address}&withTokenBalances=true`, options)
